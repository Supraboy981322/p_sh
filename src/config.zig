...
pub fn read(term:*Term) !void {
    ...
    var config_file = try (try term.cwd()).openFile(term.io, config_path, .{});
    var buf:[1024]u8 = undefined;
    var reader = &@constCast(&config_file.reader(term.io, &buf)).interface;
    defer config_file.close(term.io);
